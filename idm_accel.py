...
BYTES_PER_SAMPLE = 6
SAMPLES_PER_BLOCK = 8
def IDM_I2C_from_config(config, default_addr=None, default_speed=100000):
    # Load bus parameters
    printer = config.get_printer()
    i2c_mcu = config.get_printer().lookup_object('idm')._mcu
...
class MPU9250:
    def __init__(self, config):
        ...
        self.i2c = IDM_I2C_from_config(config,
